...
final class CustomProductListApiResource extends ResourceBase {
  ...
  public function post(array $data): ModifiedResourceResponse {
    ...
    $this->logger->notice('Created new custom product list api record @id.', ['@id' => $data['id']]);
  ...
  public function patch($id, array $data): ModifiedResourceResponse {
    ...
    $this->logger->notice('The custom product list api record @id has been updated.', ['@id' => $id]);
  ...
  public function delete($id): ModifiedResourceResponse {
    ...
    $this->logger->notice('The custom product list api record @id has been deleted.', ['@id' => $id]);
